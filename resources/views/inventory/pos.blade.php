	    	...
	    	<div class="row">
	    		<div class="col-sm-1 bg-white h-100vh ">
	    			...
	    			<div class="pos top-menu mt-20 text-center">
		    			<a href="{{url('admin//inventory')}}" class="nav-link m-auto mb-10" ><i class="ik ik-arrow-left-circle"></i></a>
                        ...
                        <a class="nav-link m-auto mb-10" href="{{url('admin/profile')}}"><i class="ik ik-user"></i></a>
                        <a class="nav-link m-auto mb-10" href="{{ url('admin/logout') }}">
    ...
    <div class="modal fade edit-layout-modal pr-0 " id="InvoiceModal" role="dialog" aria-labelledby="InvoiceModalLabel" aria-hidden="true">
	    <div class="modal-dialog mw-70" role="document">
	        <div class="modal-content">
	            ...
	            <div class="modal-body">
	                <div class="card-header"><h3 class="d-block w-100">luxfair<small class="float-right">07/10/2021</small></h3></div>
	                <div class="card-body">
	                    <div class="row invoice-info">
	                        <div class="col-sm-4 invoice-col">
	                            From
	                            <address>
	                                <strong>luxfair,</strong><br>795 Folsom Ave, Suite 546 <br>San Francisco, CA 54656 <br>Phone: (123) 123-4567<br>Email: info@luxfair.com
	                            </address>
	                        </div>
	                        <div class="col-sm-4 invoice-col">
	                            To
