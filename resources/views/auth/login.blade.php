                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 m-auto">
                        <div class="authentication-form mx-auto">
                            <div class="logo-centered">
                                <a href=""><img height="40" src="{{ asset('img/logo.png') }}" alt="luxfair" style="width:100%" ></a>
                            </div>
                            <p>Welcome back! </p>
                            ...
                            @csrf
                                ...
                                <!-- <div class="register">
                                    <p>{{ __('No account?')}} <a href="{{url('admin/register')}}">{{ __('Sign Up')}}</a></p>
                                </div> -->
