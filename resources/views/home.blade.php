    ...
    <body class="home-gradient-bg">
		<div class="container ">
			<div class="d-flex justify-content-between my-5">
				<div>
					<a href="https://arthemic.com/products/luxfair/">
		            	<img height="30" src="{{ asset('img/logo.png') }}">
		            </a>
				</div>
				<div>
					<a class="btn btn-success btn-rounded mr-3" href="{{url('admin/login')}}/">Demo</a>
					<a class="btn btn-warning btn-rounded" href="https://arthemicofficial.github.io/luxfair-Laravel-Admin-Starter-Kit/">Documentation</a>
				</div>
			</div>
	    	...
	    	<div class="luxfair-bannner text-center">
	    		<img  src="{{asset('/img/luxfair.jpg')}}">
	    	</div>
