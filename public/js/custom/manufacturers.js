(function($) {
    'use strict';
        ...
        $(document).ready(function()
        {
            ...
            var dTable = $('#manufacturers_table').DataTable({
            ...
            dTable.MakeCellsEditable({
                "onUpdate": updatemanufacturers, //call function to update in backend
        ...
        function updatemanufacturers (updatedCell, updatedRow, oldValue) 
        {
            var id = updatedRow.data().id;
            var name = updatedRow.data().name;
            var description = updatedRow.data().description;
            $.ajax({
